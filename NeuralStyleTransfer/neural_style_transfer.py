...
if __name__ == "__main__":
    ...
    content_images_dir = os.path.join(root_dir, 'VKITTI', 'VKITTI', 'train', 'images', 'Scene01_clone_camera00_00000.jpg')
    # content_images_dir = os.path.join(root_dir, 'VKITTI', 'VKITTI', 'train', 'images') # for process_directory
    style_image_dir = os.path.join(root_dir, 'pytorch-neural-style-transfer', 'style_images', 'darkroad.png')
    output_img_dir = os.path.join(root_dir, 'pytorch-neural-style-transfer', 'output-dir')
    labels_dir = os.path.join(root_dir, 'VKITTI', 'VKITTI', 'train', 'labels')
    ...
    # ... [optimization_config remains unchanged]

    start_time = time.time()

    # Using process_directory function to process entire directory
